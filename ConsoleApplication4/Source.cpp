...
void DesenhaFase5(void)
{
	...
	if (p1.getY() > 450 && p1.getY() < 500)
	{
		primitiva = VITORIA;//mudar para primitiva de creditos
	}
...
void Desenha(void)
{
	...
	case FASE1:  DesenhaFase1();
		break;
	case FASE2:  DesenhaFase2();
		break;
	case FASE3:  DesenhaFase3();
		break;
	case FASE4:  DesenhaFase4();
		break;
	case FASE5:  DesenhaFase5();
		break;
...
void InicializaFase1(void)
{
	...
	*/
	...
	int i, j;
	int linhas = countlines("teste.txt");
	float value[10000][6];
	FILE *archivo;
	archivo = fopen("teste.txt", "r");
	if (archivo == NULL)
		exit(1);
	i = 0;
